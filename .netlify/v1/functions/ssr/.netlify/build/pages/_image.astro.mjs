...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_C2k_9nQZ.mjs'
    ).then(n => n.s).catch((e) => {
...
}, "/home/ibrahim/Work/cxpert2.0/node_modules/astro/components/Image.astro", undefined);
...
}, "/home/ibrahim/Work/cxpert2.0/node_modules/astro/components/Picture.astro", undefined);
