...
export default function Testimonials() {
  ...
  const cardParallax = useParallax({
  ...
  const testimonials = [
    {
      quote:
        'CXperts has revolutionized our customer service operations. Their innovative solutions and dedicated team have significantly improved our customer satisfaction scores and operational efficiency. The level of expertise and commitment they bring is truly exceptional.',
      author: 'Sarah Johnson',
      position: 'Head of Customer Experience',
      company: 'TechCorp Solutions',
      logo: '/public/techcorp.webp',
    },
    {
      quote:
        'Working with CXperts has been a game-changing experience. Their deep understanding of customer needs and ability to adapt to our unique requirements has helped us achieve remarkable growth. The results speak for themselves - our customer retention has increased by 40%.',
      author: 'Michael Chen',
      position: 'CEO',
  ...
  return (
    <section className="py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-400 to-yellow-400 text-transparent bg-clip-text mb-4">
            What Our Clients Say
          </h2>
          <p className="text-blue-200/80 max-w-2xl mx-auto">
            Don't just take our word for it. Here's what industry leaders have to say about their experience with CXperts.
          </p>
        </motion.div>

        <motion.div
          ref={cardParallax.ref}
          style={{ y: cardParallax.value }}
